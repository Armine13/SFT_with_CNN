function output = run_Salzmann09(templateData, inputImageData, options, WITHPLOT)
% This function runs the method of Salzmann09 with a flat or non-flat template
% M. Salzmann and P. Fua. Reconstructing sharply folding surfaces: A convex formulation.
% In International Conference on Computer Vision and Pattern Recognition, 2009. 11, 13, 16, 19
...
[meshOut,Q] = SalzReconstruction(q(1:2,:), ind_tri, [b1;b2;b3]', meshIn, inputImageData.KK);
...
if WITHPLOT
    ...
    hold off;
    legend('GT crsp',['Estimated crsp using Salzmann09']);
    axis equal;
