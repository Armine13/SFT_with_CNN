...
def find_path():
    lib_paths = [ os.path.abspath('/home/arvardaz/SFT_with_CNN/comp_with_sota/releaseV1_2/dep/flann-1.8.4-src/build/lib'), abspath(join(dirname(dirname(sys.argv[0])), '../../../lib')) ]
