function [psImg1,psImg2,ds1,ds2] = GAIM_matcher(img1f,img2f,workDir,detectorOpts,matchOpts,deleteTemFiles,verb, WITHPLOT)
...
% This is free software covered by the FreeBSD License (see GAIM_license.txt)
% 
