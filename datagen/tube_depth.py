...
outdir = '/home/arvardaz/Dropbox/datasets/tube_depth/'
...
#    obj.parent.pose.bones['Bone.005'].location = loc + Vector((np.random.uniform(-3,3),np.random.uniform(-3,3),np.random.uniform(-5,-3)))
    ...
    bpy.context.scene.objects.active = bpy.data.objects['new_2k']
...
#    break
    ...
    depths = np.linspace(7, 13, frames)
    
#    obj.location = Vector((0,0,-7))
#    break
    for j, d in enumerate(depths):
        obj.location = Vector((0,0,-d))
