...
def paperDeform(obj):
    ...
    obj.modifiers["Wave"].height = (-1)**np.random.randint(1,3)*0.5
    obj.modifiers["Wave"].start_position_x = (-1)**np.random.randint(1,3)*np.random.uniform(3, 23)
    obj.modifiers["Wave"].start_position_y = (-1)**np.random.randint(1,3)*np.random.uniform(2, 23)
    obj.modifiers["Wave"].narrowness = np.random.uniform(0, 1.51)
    obj.modifiers["Wave"].time_offset = np.random.uniform(-200,-60)
...
outdir = '/home/arvardaz/Dropbox/datasets/paper/train/'
outdir_test = '/home/arvardaz/Dropbox/datasets/paper/test/'
