...
outdir = '/home/arvardaz/Dropbox/datasets/fl/rig_rt+fl+l+bg/train/'
outdir_test = '/home/arvardaz/Dropbox/datasets/fl/rig_rt+fl+l+bg/test/'
#outdir = directory + '/temp/'

#background
#bg_dir = directory + 'SBU-RwC90/mixed/slices/'
bg_dir = '/home/arvardaz/SFT_with_CNN/SBU-RwC90/mixed/slices/'
